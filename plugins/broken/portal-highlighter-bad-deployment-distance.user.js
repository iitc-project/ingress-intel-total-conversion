...
// @description    [@@BUILDNAME@@-@@BUILDDATE@@] Use the portal fill color to denote the effective resonator deployment range, where that average is less than 36 metres.
