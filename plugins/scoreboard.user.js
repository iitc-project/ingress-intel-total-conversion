...
window.plugin.scoreboard.portalTable = function() {
  ...
  var avgEnl, avgHealthEnl;
  if(window.plugin.scoreboard.enlP!==0){
    avgEnl = window.plugin.scoreboard.enlPorLevels/window.plugin.scoreboard.enlP;
    avgEnl = avgEnl.toFixed(1);
    avgHealthEnl = window.plugin.scoreboard.healthEnl/window.plugin.scoreboard.enlP;
  ...
  var avgRes, avgHealthRes;
  if(window.plugin.scoreboard.resP!==0){
    avgRes = window.plugin.scoreboard.resPorLevels/window.plugin.scoreboard.resP;
    avgRes = avgRes.toFixed(1);
    avgHealthRes = window.plugin.scoreboard.healthRes/window.plugin.scoreboard.resP;
