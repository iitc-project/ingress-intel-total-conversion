...
window.plugin.portalcounts.getPortals = function (){
  ...
  if(total > 0) {
    ...
    for(level = window.MAX_PORTAL_LEVEL; level > 0; level--){
  ...
  total = self.enlP + self.resP + self.neuP;
