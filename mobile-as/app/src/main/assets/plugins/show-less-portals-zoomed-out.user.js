...
// @updateURL      none
// @downloadURL    none
// @description    [mobile-2016-12-17-075355] Vastly reduce the detail level when zoomed out to level 11 or less (L4+ portals), to significantly reduce data usage when viewing large areas.
