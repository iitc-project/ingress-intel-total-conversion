...
// @updateURL      none
// @downloadURL    none
// @description    [mobile-2016-12-17-075355] EXPERIMENTAL: use canvas-based rendering. Can be faster when viewing dense areas. Limited testing of the feature so far
