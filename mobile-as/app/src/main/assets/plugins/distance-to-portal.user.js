...
// @updateURL      none
// @downloadURL    none
// @description    [mobile-2016-12-17-075355] Allows your current location to be set manually, then shows the distance to the selected portal. Useful when managing portal keys.
