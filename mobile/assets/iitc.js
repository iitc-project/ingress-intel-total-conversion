...
// @version        0.9.1.20130321.220402
// @namespace      https://github.com/jonatkins/ingress-intel-total-conversion
// @updateURL      none
// @downloadURL    none
// @description    [local-2013-03-21-220402] Total conversion for the ingress intel map.
...
window.iitcBuildDate = '2013-03-21-220402';
...
function boot() {
  ...
  console.log('loading done, booting. Built: 2013-03-21-220402');
  if(window.deviceID) console.log('Your device ID: ' + window.deviceID);
  window.runOnSmartphonesBeforeBoot();

  // overwrite default Leaflet Marker icon to be a neutral color
  var base = 'http://iitc.jonatkins.com/release/images';
