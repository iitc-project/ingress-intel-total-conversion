...
// @version        0.26.0.20181030.90244
// @namespace      https://github.com/jonatkins/ingress-intel-total-conversion
// @updateURL      none
// @downloadURL    none
// @description    [mobile-2018-10-30-090244] Total conversion for the ingress intel map.
...
window.iitcBuildDate = '2018-10-30-090244';
...
function boot() {
  ...
  console.log('loading done, booting. Built: 2018-10-30-090244');
  ...
  if (niantic_params.CURRENT_VERSION === undefined) {
    dialog({
      ...
      html: '<p>IITC failed to extract the required parameters from the intel site</p>'
           +'<p>This can happen after Niantic update the standard intel site. A fix will be needed from the IITC developers.</p><br/>'
           + JSON.stringify(window.niantic_params,null,2),
    });
...
var script = document.createElement('script');
var info = { buildName: 'mobile', dateTimeVersion: '20181030.90244' };
